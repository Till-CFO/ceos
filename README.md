...
**Run EOS with AI.** CEOS brings the [Entrepreneurial Operating System](https://www.eosworldwide.com/) to [Claude Code](https://docs.anthropic.com/en/docs/claude-code), giving your leadership team six AI-powered skills for Vision, Rocks, Scorecard, L10 Meetings, IDS, and People Analyzer.
...
```
┌─────────────────────────────────┐
│  skills/ceos-*/SKILL.md         │  ← Claude Code skills (6 EOS tools)
├─────────────────────────────────┤
